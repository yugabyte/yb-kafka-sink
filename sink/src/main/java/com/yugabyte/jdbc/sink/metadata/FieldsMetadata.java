...
package com.yugabyte.jdbc.sink.metadata;
...
public class FieldsMetadata {
  ...
  private FieldsMetadata(
    ...
    boolean allFieldsContained =
        (allFields.keySet().containsAll(keyFieldNames)
  ...
  private static void extractKafkaPk(
    ...
    allFields.put(
        partitionFieldName, new SinkRecordField(Schema.INT32_SCHEMA, partitionFieldName, true));
      ...
      if (keySchema == null) {
        throw new ConnectException(
            String.format(
                ...
                tableName, JdbcSinkConfig.PrimaryKeyMode.RECORD_KEY));
      }
    ...
    if (valueSchema == null) {
      throw new ConnectException(
          String.format(
              ...
              tableName, JdbcSinkConfig.PrimaryKeyMode.RECORD_VALUE));
    }
    if (configuredPkFields.isEmpty()) {
