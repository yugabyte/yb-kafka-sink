...
import static com.yugabyte.jdbc.sink.JdbcSinkConfig.InsertMode.INSERT;
import static java.util.Objects.isNull;
import static java.util.Objects.nonNull;

import com.yugabyte.jdbc.dialect.DatabaseDialect;
import com.yugabyte.jdbc.dialect.DatabaseDialect.StatementBinder;
...
public class BufferedRecords {
  ...
  public List<SinkRecord> flush() throws SQLException {
    ...
    log.trace(
        "{} records:{} resulting in totalUpdateCount:{} totalDeleteCount:{}",
        config.insertMode,
        records.size(),
        totalUpdateCount,
        totalDeleteCount);
    if (totalUpdateCount.filter(total -> total != expectedCount).isPresent()
      ...
      throw new ConnectException(
          String.format(
              ...
              totalUpdateCount.get(), expectedCount));
    }
