...
import com.yugabyte.jdbc.util.ExpressionBuilder.Expressable;
...
public class ColumnId implements Expressable {
   ...
   * usually specified by the SQL <code>AS</code> clause. If a SQL <code>AS</code> is not specified,
   * the value will be the same as the value returned by the {@link #name()} method.
   *
