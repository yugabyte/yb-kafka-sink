...
/**
 * General string utilities that are missing from the standard library and may commonly be required
 * by Connector or Task implementations.
 */
public class StringUtils {

  /**
   * Generate a String by appending all the @{elements}, converted to Strings, delimited by {@code
   * delim}.
   *
