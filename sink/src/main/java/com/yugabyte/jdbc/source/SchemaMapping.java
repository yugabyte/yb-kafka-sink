...
public final class SchemaMapping {
  ...
  public static SchemaMapping create(
      String schemaName, ResultSetMetaData metadata, DatabaseDialect dialect) throws SQLException {
  ...
  private SchemaMapping(Schema schema, Map<String, ColumnConverter> convertersByFieldName) {
    assert schema != null;
