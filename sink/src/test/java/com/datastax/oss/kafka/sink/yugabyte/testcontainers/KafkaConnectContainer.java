...
import static com.datastax.oss.kafka.sink.yugabyte.testcontainers.Utils.CONFLUENT_PLATFORM_VERSION;
import static com.datastax.oss.kafka.sink.yugabyte.testcontainers.Utils.containerLogsConsumer;
...
/**
 * This file is a slight adapatation of the KafkaConnectContainer code available on ydespreaux's
 * Github account:
 *
 * @see <a
 *     href="https://github.com/ydespreaux/testcontainers/blob/master/testcontainers-kafka/src/main/java/com/github/ydespreaux/testcontainers/kafka/containers/KafkaConnectContainer.java">KafkaConnectContainer.java</a>
 */
public class KafkaConnectContainer extends GenericContainer<KafkaConnectContainer> {
  ...
  public static final String KEY_CONVERTER_SCHEMA_REGISTRY_URL_CONFIG =
      "CONNECT_KEY_CONVERTER_SCHEMA_REGISTRY_URL";
  public static final String VALUE_CONVERTER_CONFIG = "CONNECT_VALUE_CONVERTER";
  public static final String VALUE_CONVERTER_SCHEMA_REGISTRY_URL_CONFIG =
  ...
  private static final String OFFSET_STORAGE_FILE_FILENAME_DEFAULT_VALUE =
      "connect-offsets-file.txt";
  ...
  private static final String KEY_CONVERTER_DEFAULT_VALUE =
      "org.apache.kafka.connect.json.JsonConverter";
  private static final String KEY_CONVERTER_SCHEMAS_ENABLE_CONFIG =
      "CONNECT_KEY_CONVERTER_SCHEMAS_ENABLE";
  private static final String VALUE_CONVERTER_DEFAULT_VALUE =
      "org.apache.kafka.connect.json.JsonConverter";
  private static final String VALUE_CONVERTER_SCHEMAS_ENABLE_CONFIG =
  ...
  private static final String INTERNAL_KEY_CONVERTER_DEFAULT_VALUE =
      "org.apache.kafka.connect.json.JsonConverter";
  private static final String INTERNAL_VALUE_CONVERTER_CONFIG = "CONNECT_INTERNAL_VALUE_CONVERTER";
  private static final String INTERNAL_VALUE_CONVERTER_DEFAULT_VALUE =
      "org.apache.kafka.connect.json.JsonConverter";
  ...
  public KafkaConnectContainer(String confluentPlatformVersion, String bootstrapServers) {
    ...
    this.withLogConsumer(containerLogsConsumer(logger()))
        ...
        .withEnv(
            ...
            String.valueOf(OFFSET_STORAGE_PARTITIONS_DEFAULT_VALUE))
        .withEnv(
        ...
        .withEnv(
            ...
            String.valueOf(STATUS_STORAGE_PARTITIONS_DEFAULT_VALUE))
        .withEnv(
  ...
  public KafkaConnectContainer withPlugins(String plugins) {
    ...
    if (!pluginsFile.exists()) {
      throw new IllegalArgumentException(
          format("Resource with path %s could not be found", pluginsPath.toString()));
    }
    ...
    if (pluginsFile.isDirectory()) {
      ...
      containerPath +=
          "/" + pluginsPath.getParent().getFileName() + "/" + pluginsPath.getFileName();
    }
  ...
  public String getUrl() {
    return format(
        "http://%s:%d", this.getContainerIpAddress(), getMappedPort(CONNECT_REST_PORT_INTERNAL));
  }
