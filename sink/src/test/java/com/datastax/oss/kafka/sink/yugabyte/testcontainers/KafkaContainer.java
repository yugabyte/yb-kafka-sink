...
import static com.datastax.oss.kafka.sink.yugabyte.testcontainers.Utils.*;
...
/**
 * This class is a testcontainers Confluent implementation for the Apache Kafka docker container.
 */
public class KafkaContainer extends GenericContainer<KafkaContainer> {
  ...
  public KafkaContainer(String confluentPlatformVersion, String zookeeperConnect) {
    ...
    this.internalBootstrapServersUrl =
        format("%s:%d", networkAlias, KAFKA_INTERNAL_ADVERTISED_LISTENERS_PORT);
  }
